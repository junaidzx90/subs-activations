...
add_action('admin_enqueue_scripts',function(){
    // admin css
    if (isset($_GET['page']) && ($_GET['page'] == 'activations' || $_GET['page'] == 'settings')) {
        wp_enqueue_style( 'admin-view', SUBSACT_URL.'css/admin-view.css', array(), microtime(), 'all' );
        wp_enqueue_style( 'select2', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css', array(), '1.1', 'all' );
    }

    wp_register_script( 'select2', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js', array(), '1.1', true );
